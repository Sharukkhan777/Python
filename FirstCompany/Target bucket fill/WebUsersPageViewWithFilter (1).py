...
def get_results(service, profile_id):
    ...
    # for the number of sessions within the past seven days.
        a.append(service.data().ga().get(
                ...
                end_date='2019-08-20',
                dimensions = 'ga:dimension2,ga:pagePath,ga:sourceMedium',
                metrics='ga:pageviews',
                filters='ga:dimension2!~n',
...
def print_results(results):
  ...
  df_temp.to_csv(r'H:\prasannaraj.s\sharukkhan\python codes\Target bucket fill\WebUserPageViews.csv')
